...
import com.github.nkuppan.country.example.databinding.MainActivityBinding
...
class XMLMainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.searchLegacyActivity.setOnClickListener {
            launchCountrySelectionActivity()
        }
